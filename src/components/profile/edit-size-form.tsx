// src/components/profile/edit-size-form.tsx
"use client";
...
export function EditSizeForm({ size, brands }: EditSizeFormProps) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      brandId: size.brandId || undefined,
      customBrand: "",
      value: size.value,
      notes: size.notes || "",
    },
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      // Envoyer la requête pour mettre à jour la taille
      ...
      toast({
        ...
        description: "La taille a été mise à jour avec succès.",
      });
      ...
      toast({
        variant: "destructive",
        title: "Erreur",
        description: "Une erreur est survenue lors de la mise à jour de la taille.",
      });
    } finally {
      setIsLoading(false);
    }
